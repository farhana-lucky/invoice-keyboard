    ...
    <div class="container-fluid px-5 pb-16">
        <div class="flex flex-wrap -mx-4 -mb-10 text-center">
            <div class="w-full mb-10 px-4">
                ...
                <form action="{{ route('invoice.update',[$invoice->number]) }}" method="POST" class="md:w-full px-10 pt-10 pb-5 bg-white rounded-lg shadow-xl border">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-3">
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('name') border-red-500 @enderror" value="{{ $invoice->name }}" name="name" id="name" placeholder="Enter Client Name" maxlength="70" onkeypress="nameValidation(event)" autocomplete="off">
                                    @error('name')
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('date') border-red-500 @enderror" value="{{ old('date')!= null? old('date'): date('d/m/Y', strtotime($invoice->date)) }}" name="date" id="date" placeholder="Enter Date" autocomplete="off" readonly>
                                    @error('date')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="number" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('phone') border-red-500 @enderror" value="{{ $invoice->phone }}" name="phone" id="phone" placeholder="Enter Phone" onkeypress="if (!/^[0-9]+$/.test(String.fromCharCode(event.keyCode))) {return false;}return true;" autocomplete="off">
                                    @error('phone')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="email" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('email') border-red-500 @enderror" value="{{ $invoice->email }}" name="email" id="email" placeholder="example@email.com" autocomplete="off">
                                    @error('email')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-3">
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            ...
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('from_address') border-red-500 @enderror" value="{{ $invoice->from_address }}" name="from_address" id="from_address" maxlength="70" placeholder="Enter From Address" autocomplete="off">
                                    @error('from_address')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            ...
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('to_address') border-red-500 @enderror" value="{{ $invoice->to_address }}" name="to_address" id="to_address" maxlength="70" placeholder="Enter To Address" autocomplete="off">
                                    @error('to_address')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-3">
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3 flex w-full">
                                    <div class="w-2/3">
                                        <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('start_time') border-red-500 @enderror" value="{{ $invoice->start_time }}" name="start_time" id="start_time" onfocusout="costCalculation()" placeholder="Enter Time" autocomplete="off">
                                        @error('start_time')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3 flex w-full">
                                    <div class="w-2/3">
                                        <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('end_time') border-red-500 @enderror" value="{{ $invoice->end_time }}" name="end_time" id="end_time" onfocusout="costCalculation()" placeholder="Enter Time" autocomplete="off">
                                        @error('end_time')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3 flex w-full">
                                    <div class="w-2/3">
                                        <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('work_hours') border-red-500 @enderror" value="{{ $invoice->work_hours }}" name="work_hours" id="work_hours" placeholder="Enter Time" autocomplete="off" readonly>
                                        @error('work_hours')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="relative md:w-2/3">
                                    <input type="number" step="0.01" min="0" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('rate') border-red-500 @enderror" value="{{ $invoice->rate }}" name="rate" id="rate" onkeyup="costCalculation()" placeholder="Enter Rate" autocomplete="off">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="relative md:w-2/3">
                                    <input type="number" step="0.01" min="0" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('supplies') border-red-500 @enderror" value="{{ $invoice->supplies }}" name="supplies" id="supplies" onkeyup="costCalculation()" placeholder="Enter value" autocomplete="off">
                                    <div class="text-2xl pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-700">
                                        &#36;
                                    </div>
                                    @error('supplies')
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="relative md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('subtotal') border-red-500 @enderror" value="{{ $invoice->subtotal }}" name="subtotal" id="subtotal" placeholder="Subtotal" autocomplete="off" readonly>
                                    <div class="text-2xl pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-700">
                                        &#36;
                                    </div>
                                    @error('subtotal')
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="relative md:w-2/3">
                                    <input type="number" step="0.01" min="0" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('tax') border-red-500 @enderror" value="{{ $invoice->tax }}" name="tax" id="tax" onkeyup="costCalculation()" placeholder="Enter Tax value" autocomplete="off">
                                    <div class="text-2xl pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-700">
                                        &#37;
                                    </div>
                                    @error('tax')
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="relative md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('total') border-red-500 @enderror" value="{{ $invoice->total }}" name="total" id="total" placeholder="Total" autocomplete="off" readonly>
                                    <div class="text-2xl pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-700">
                                        &#36;
                                    </div>
                                    @error('total')
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full md:w-1/3 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('driver') border-red-500 @enderror" value="{{ $invoice->driver }}" name="driver" id="driver" placeholder="Enter Name" maxlength="30" onkeypress="if (!/^[A-Za-z, ]+$/.test(String.fromCharCode(event.keyCode))) {return false;}return true;" autocomplete="off">
                                    @error('driver')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('helper') border-red-500 @enderror" value="{{ $invoice->helper }}" name="helper" id="helper" placeholder="Enter Name" maxlength="80" onkeypress="if (!/^[A-Za-z, ]+$/.test(String.fromCharCode(event.keyCode))) {return false;}return true;" autocomplete="off">
                                    @error('helper')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-2">
                            <div class="md:flex md:items-center">
                                ...
                                <div class="md:w-2/3">
                                    <input type="text" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('vehicle') border-red-500 @enderror" value="{{ $invoice->vehicle }}" name="vehicle" id="vehicle" placeholder="Enter Info" maxlength="30" autocomplete="off">
                                    @error('vehicle')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="mx-3 ml-auto inline-flex rounded-md shadow">
                            ...
                            <button type="submit" class="mx-3 bg-blue-500 hover:bg-blue-700 block uppercase tracking-wide text-white text-xs font-bold rounded px-8 py-2 focus:outline-none focus:shadow-outline" onclick="button('print')">
                                Print View
                            </button>
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 block uppercase tracking-wide text-white text-xs font-bold rounded px-8 py-2 focus:outline-none focus:shadow-outline" onclick="button('email')">
                                Email
                            </button>
                        </div>
                    </div>
