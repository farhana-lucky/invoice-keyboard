...
let selectionEnd = 0;
let createElement = document.getElementById("operation_details");
...
let selectionEnd2 = 0;
let createElement2 = document.getElementById("comment_instruction");
...
const createButton = () => {
    ...
    arr.map((item, index) => {
        if (item.type === "str" && index >= fromLength && index <= toLength) {
            buttonText += `<div class="col col-md pl-0 pr-0 pb-0 mb-0 "><button onclick="getData('${item.value}')" type="button" class="btn btn-light p-0 btn-block button_custom_br">${item.value} </button></div>`;
        }
        else if (item.type === "num") {
            buttonNum += `<div class="col col-md pl-0 pr-0 mb-0 "><button onclick="getData('${item.value}')" type="button" class="btn btn-light p-0 btn-block button_custom_br">${item.value} </button></div>`;
        }
    });
...
const createButton2 = () => {
    ...
    arr.map((item, index) => {
        if (item.type === "str" && index >= fromLength2 && index <= toLength2) {
            buttonText += `<div class="col col-md pl-0 pr-0 pb-0 mb-0 "><button onclick="getData2('${item.value}')" type="button" class="btn btn-light p-0 btn-block button_custom_br">${item.value} </button></div>`;
        }
        else if (item.type === "num") {
            buttonNum += `<div class="col col-md pl-0 pr-0 mb-0 "><button onclick="getData2('${item.value}')" type="button" class="btn btn-light p-0 btn-block button_custom_br">${item.value} </button></div>`;
        }
    });
